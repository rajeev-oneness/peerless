...
<BODY>
    ...
    <STYLE type="text/css">
        ...
        .t1{width: 691px;margin-top: 75px;font: bold 13px 'Arial';}
                    ...
                    <TABLE cellpadding=0 cellspacing=0 class="t1" style="border: 0">
                        <TR style="border: 0">
                            <TD class="tr6 td23" style="border: 0">
                                {{-- <img src="{{asset($data->signatureoftheauthorisedsignatory)}}" alt="" style="height: 50px"> --}}
            ...
            <DIV id="page_16">
                ...
                <table class="border0">
                    ...
                    <tr>
                        ...
                        <td class="border0" colspan="7" style="margin: 0; padding:0; line-height:0;">
                            <p>&nbsp;</p>
                            <p class="ft1" style="text-align: right">Name : {{$data->witness1fullname}}</p>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="1" class="border0">
                        ...
                        <td class="border0" colspan="7" style="margin: 0; padding:0; line-height:0;">
                            <p>&nbsp;</p>
                            <p class="ft1" style="text-align: right">Address : {{$data->witness1streetaddress}}</p>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="1" class="border0">
                ...
                <table class="border0">
                    ...
                    <tr>
                        ...
                        <td class="border0" colspan="7" style="margin: 0; padding:0; line-height:0;">
                            <p>&nbsp;</p>
                            <p class="ft1" style="text-align: right">Name : {{$data->witness2fullname}}</p>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="1" class="border0">
                        ...
                        <td class="border0" colspan="7" style="margin: 0; padding:0; line-height:0;">
                            <p>&nbsp;</p>
                            <p class="ft1" style="text-align: right">Address : {{$data->witness2streetaddress}}</p>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="1" class="border0">
