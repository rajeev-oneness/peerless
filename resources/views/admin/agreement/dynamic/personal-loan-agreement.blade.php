...
<BODY>
    ...
    <STYLE type="text/css">
        ...
        /* Page 18  */
        #page_18 {position:relative; overflow: hidden;margin: 44px 0px 35px 48px;padding: 0px;border: none;width: 746px;}
        #page_18 #id18_1 {text-align: center; border:none;padding: 0px;border:none;}
        ...
        #page_24 {position:relative; overflow: hidden;margin: 47px 0px 37px 50px;padding: 0px;border: none;width: 744px;}
        ...
        #page_28 {margin:0; padding:30px 50px;}
        ...
        #page_29 {margin:0; padding:30px 50px;}
        ...
        #page_31 {margin:0; padding:30px 50px;}
        ...
        #page_32  {margin:0; padding:30px 50px;}
    ...
    <DIV id="page_16">
        ...
        <table class="border0">
            <tr>
                <td class="border0" colspan="8">
                    <p class="ft0" style="text-decoration: none; font-family:sans-serif;">For Lender</p>
                </td>
            </tr>
            <tr>
        ...
        <table class="border0">
            <tr>
                <td class="border0" colspan="8">
                    <p class="ft0" style="text-decoration: none; font-family:sans-serif;">For Witness</p>
                </td>
            </tr>
            <tr>
                ...
                <td class="border0" colspan="7" style="margin: 0; padding:0; line-height:0;">
                    <p>&nbsp;</p>
                    <p class="ft1" style="text-align: right">Name : ___________________________________________________________________________________</p>
            ...
            <tr>
                ...
                <td class="border0" colspan="7" style="margin: 0; padding:0; line-height:0;">
                    <p>&nbsp;</p>
                    <p class="ft1" style="text-align: right">Address : ___________________________________________________________________________________</p>
            ...
            <tr>
                ...
                <td class="border0" colspan="7" style="margin: 0; padding:0; line-height:0;">
                    <p>&nbsp;</p>
                    <p class="ft1" style="text-align: right">City : ___________________ <span>Pin code</span>_________________________ <span>State</span>___________________________</p>
        ...
        <table class="table_23 border0" style="width:80%; margin:0 auto;">
            ...
            <tr>
                ...
                <p class="ft131">
                    ...
                    Presentment for payment and requirement of prior notice and protest of this Note are hereby unconditionally and
                    irrevocably waived.
                    <br><br>
                </p>
            ...
            <tr class="stamp-tr">
                ...
                <td class="border0">
                    <p style="display:block; width:80%; margin:0 auto; text-align: center; border-top:1px solid #000;">
    ...
    <div id="page_24">
        ...
        <DIV style="text-align:center;">
            <P class="p13 ft1" style="border: 1px solid #000;margin-top: 20px;padding: 2px; display: inline-block;">100/- Non Judicial Stamp to be affixed</P>
            <P class="ft5">ANNEXURE II</P>
            <p class="ft5">CONTINUING SECURITY LETTER</p>
            <P class="ft1">(This Continuing Security Letter executed at the place and date stated in the Schedule I therein under written)</P>
            <br><br><br>
        </div>
        ...
        <TABLE class="t1 border0" style="width: 10% !important; margin:0 auto;">
            <TR style="border: 0">
                <TD class="tr6 td23" style="border: 0">
                    <P style="display:inline-block; border-top:1px solid #000;" class="p15 ft2">Authorised Signatories For PFSL</P>
                </TD>
                <td style="border: 0"></td>
                <TD class="tr6 td24" style="border: 0">
                    <P style="display:inline-block; border-top:1px solid #000;" class="p15 ft2">Borrower</P>
                </TD>
                <td style="border: 0"></td>
                <TD class="tr6 td25" style="border: 0">
                    <P style="display:inline-block; border-top:1px solid #000;" class="p15 ft2">Co-Borrower</P>
                </TD>
            </TR>
        </TABLE>
    ...
    <DIV id="page_25">
        ...
        <DIV style="text-align:center;">
            ...
            <P class="ft1">(This Undertaking Cum Indemnity executed at the place and date stated in the Schedule I therein under written )</P>
            <br><br><br>
        </div>
        ...
        <P class="p53 ft3">
            ...
            <SPAN class="ft142">
                If at any time hereafter any stamp authority or other appropriate authority shall levy or require payment of any
                stamp duty/ differential stamp duty, interest or penalty or any other amount in the nature of stamp duty on the
                said Personal Loan Facility Agreement, I/ we shall forthwith upon receiving a demand from such authority or
                from you, pay to such authority or deposit with you the amount of stamp duty/ differential stamp duty/ interest/
                penalty or any other amount in the nature of stamp duty so claimed in respect of the said Personal Loan Facility
                Agreement;
            </SPAN>
        </P>
        ...
        <P class="p53 ft3">
            ...
            <SPAN class="ft142">
                I / we shall make such payment/deposit irrespective of whether any proceeding by way of appeal, review,
                revision or representation challenging the levy or demand of any such stamp duty or differential stamp duty or
                penalty or otherwise may have been filed by me or any other person or that may be otherwise pending before
        ...
        <P class="p53 ft3">
            ...
            <SPAN class="ft142">
                I / we hereby confirm that a certificate by an authorized official of PFSL as to the amount levied or payable or to
                be deposited as aforesaid shall be binding upon me/ us and shall be conclusive evidence of the amount of my/
                our liability;
            </SPAN>
        </P>
        ...
        <P class="p53 ft3">
            ...
            <SPAN class="ft142">
                I/ we hereby unconditionally agree to indemnify PFSL and keep PFSL, its officers and employees indemnified
                at all times in respect of any additional / differential stamp duty, interest and penalty and off, from and against any
                loss, damage, liabilities, costs, charges and expenses, whatsoever, which PFSL may incur or suffer or be put to
                in any manner whatsoever by reason of PFSL having agreed at my / our request to rely on the said Personal
        ...
        <P class="p53 ft3">
            ...
            <SPAN class="ft142">
                I / we hereby confirm that I / we have been duly authorized and empowered in all respects to execute this
                Letter of Undertaking-cum-Indemnity and I /we am/ are fully aware that on the basis thereof PFSL has
    ...
    <DIV id="page_30">
        ...
        <DIV style="text-align:center;">
            <P class="p13 ft1" style="border: 1px solid #000;margin-top: 20px;padding: 2px; display: inline-block;">To be signed by all holders of bank account, <br>
                 if mode of operation of Bank Account is 'Joint'
            </P>
            <P class="ft5">ANNEXURE VI</P>
            <p class="ft5" style="font-size:16px !important; padding:25px 0;">NACH DECLARATION</p>
            <P class="ft2">(This NACH Declaration is executed at the place and date stated in the Schedule I therein under written )</P>
            <br>
        </div>
    ...
    <DIV id="page_31">
        ...
        <DIV style="text-align:center;">
            <P class="ft5">VERNACULAR DECLARATION</P>
            <br><br><br><br><br><br>
        </div>
            ...
            <tr>
                <td  class="border0">
                    <p>
                        ...
                        <span>
                            That the Borrower Mr./ Mrs./ Miss ..................................................................................................... S /o / D/o /w/o
                            …………………………………………… is my …..……….…………………………......................... and I know him/her for the last ……………. yrs/monthsand he/she signs in the vernacular language, I. e. in
                            (name of language in which borrowers have signed) and the same has/ have been understood by him/ her. I have
                ...
                <td  class="border0">
                    <p>
                        ...
                        <span>
                            ...
                            S/o/ D/o/ w/o …………………………………………… is my ......................................................................... and I know
                            him/her for the last ……………. yrs/months and he /she signs in the vernacular language, i.e. in
                            (name of language in which borrower have signed) and the same have been understood by him / her. I have seen him
            ...
            <tr>
                <td  class="border0">
                    <p>
                        ...
                        <span>
                            That I have read out and explained in vernacular, the contents and nature of the Application form, Loan Agreement
                            along with the Schedules and all other documents signed by him/her for obtaining loan from PFSL. He/she is
            ...
            <tr>
                <td  class="border0">
                    <p>
                        ...
                        <span>
                            That he/she signing in the vernacular all the document sand the Agreements after understanding the same. His/
        ...
        <TABLE class="border0" style="width: 100% !important; margin:0 auto;">
            <TR style="border: 0">
                <TD class="tr6 td23" style="border: 0">
                    <P style="display:inline-block; border-top:1px solid #000; text-align:center; margin-right:140px;" class="p15 ft1">Signature of Borrower</P>
                    <P style="display:inline-block; border-top:1px solid #000; text-align:center; margin-right:140px;" class="p15 ft1">Co Borrower</P>
                    <P style="display:inline-block; border-top:1px solid #000; text-align:center;" class="p15 ft1">Guarantor Signature of the Executant</P>
                </TD>
            </TR>
        </TABLE>
        ...
        <table class="border0">
            ...
            <tr>
                <td class="border0">
                    <p>
                        Signature of the Executant Date :________________________________   
                    </p>
                </td>
            </tr>
        </table>
    ...
    <DIV id="page_32">
        ...
        <DIV style="text-align:center;">
            <P class="ft5">MISCELLANEOUS DOCUMENTS</P>
        </div>
        ...
        <TABLE class="t1 border0" style="width: 10% !important; margin:0 auto;">
            <TR style="border: 0">
                <TD class="tr6 td23" style="border: 0">
                    <P style="display:inline-block; border-top:1px solid #000; text-align:center;" class="p15 ft2">Authorised Signatories For PFSL</P>
                </TD>
                <td style="border: 0"></td>
                <TD class="tr6 td24" style="border: 0">
                    <P style="display:inline-block; border-top:1px solid #000; text-align:center;" class="p15 ft2">Borrower</P>
                </TD>
                <td style="border: 0"></td>
                <TD class="tr6 td25" style="border: 0">
                    <P style="display:inline-block; border-top:1px solid #000; text-align:center;" class="p15 ft2">Co-Borrower</P>
                </TD>
            </TR>
        </TABLE>
