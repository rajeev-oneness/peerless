                        ...
                        <div class="card-body">
                            <form class="form-horizontal" method="POST"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control @error('pan_card_number') {{ 'is-invalid' }} @enderror" id="pan_card_number" name="pan_card_number" placeholder="Pan card number" value="{{ old('pan_card_number') ? old('pan_card_number') : $data->user->pan_card_number }}" maxlength="10">
                                        @error('pan_card_number') <p class="small mb-0 text-danger">{{ $message }}</p>@enderror
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" id="marital_status" name="marital_status">
                                            ...
                                            @foreach ($APP_data->maritalStatus as $item)
                                                <option value="{{ $item }}" {{ $data->user->marital_status == $item ? 'selected' : '' }}>{{ $item }}</option>
                                            @endforeach
                                        </select>
