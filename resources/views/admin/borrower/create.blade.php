            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" method="POST" action="{{ route('user.borrower.store') }}"
                                id="profile-form">
                                @csrf
                                    ...
                                    <div class="col-sm-2">
                                        <select class="form-control" id="name_prefix" name="name_prefix">
                                            ...
                                            @foreach ($APP_data->namePrefix as $item)
                                                <option value="{{ $item }}"
                                                    {{ old('name_prefix') ? (old('name_prefix') == $item ? 'selected' : '') : '' }}>
                                                    {{ ucwords($item) }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" id="gender" name="gender">
                                            ...
                                            @foreach ($APP_data->genderList as $item)
                                                <option value="{{ $item }}"
                                                    {{ old('gender') ? (old('gender') == $item ? 'selected' : '') : '' }}>
                                                    {{ ucwords($item) }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text"
                                            ...
                                            name="mobile" placeholder="Phone number" value="{{ old('mobile') }}">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" id="marital_status" name="marital_status">
                                            ...
                                            @foreach ($APP_data->maritalStatus as $item)
                                                <option value="{{ $item }}"
                                                    {{ old('marital_status') ? (old('marital_status') == $item ? 'selected' : '') : '' }}>
                                                    {{ ucwords($item) }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10 offset-sm-2 mt-2">
                                        <input type="text"
                                            ...
                                            id="pincode" name="pincode" placeholder="Pincode" value="{{ old('pincode') }}">
                                        ...
                                        <select class="form-control" id="agreement_id" name="agreement_id">
                                            ...
                                            @foreach ($data->agreement as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ old('agreement_id') ? (old('agreement_id') == $item->id ? 'selected' : '') : '' }}>
                                                    {{ $item->name }}</option>
                                            @endforeach
                                        </select>
