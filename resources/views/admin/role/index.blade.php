                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                ...
                                <a href="javascript: void(0)" class="btn btn-sm btn-primary" onclick="openSidebarModal()">
                                ...
                                <tbody>
                                    @forelse ($data as $index => $item)
                                        <tr id="tr_{{ $item->id }}">
                                            ...
                                            <td>
                                                <span
                                                    class="badge bg-{{ $item->color }} rounded-0 text-uppercase">{{ $item->name }}</span>
                                            </td>
                                            <td class="text-right">
                                                <a href="javascript: void(0)" class="badge badge-dark action-button"
                                                    title="View"
                                                    onclick="viewDeta1ls('{{ route('user.role.show') }}', {{ $item->id }})">View</a>
                                                @if ($item->id != 1)
                                                    <a href="javascript: void(0)" class="badge badge-dark action-button"
                                                        title="Edit"
                                                        onclick="editRole({{ $item->id }}, '{{ $item->name }}', '{{ $item->color }}')">Edit</a>
                                                    ...
                                                    <a href="javascript: void(0)" class="badge badge-dark action-button"
                                                        title="Delete"
                                                        onclick="confirm4lert('{{ route('user.role.destroy') }}', {{ $item->id }}, 'delete')">Delete</a>
                                                @endif
                                            </td>
                                        </tr>
                                    @empty
                    ...
                    <div id="roleContent">
                        <form class="form-horizontal" method="POST" action="" id="roleForm">
                            ...
                            <div class="form-group row">
                                <label for="name" class="col-12 col-form-label">Name <span
                                        class="text-danger">*</span></label>
                                <div class="col-12">
                                    <input type="text" class="form-control" id="name" name="name"
                                        placeholder="User role name" value="">
                                </div>
                            </div>
                            <div class="form-group row"><label for="color" class="col-12 col-form-label">Color <span
                                ...
                                <div class="col-12" id="roles-holder">
                                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                        <label class="btn btn-select-color btn-sm bg-indigo"><input type="radio"
                                                name="color" value="indigo" autocomplete="off"></label>
                                        <label class="btn btn-select-color btn-sm bg-primary"><input type="radio"
                                                name="color" value="primary" autocomplete="off"></label>
                                        <label class="btn btn-select-color btn-sm bg-olive"><input type="radio" name="color"
                                                value="olive" autocomplete="off"></label>
                                        <label class="btn btn-select-color btn-sm bg-success"><input type="radio"
                                                name="color" value="success" autocomplete="off"></label>
                                        <label class="btn btn-select-color btn-sm bg-warning"><input type="radio"
                                                name="color" value="warning" autocomplete="off"></label>
                                        <label class="btn btn-select-color btn-sm bg-orange"><input type="radio"
                                                name="color" value="orange" autocomplete="off"></label>
                                        <label class="btn btn-select-color btn-sm bg-danger"><input type="radio"
                                                name="color" value="danger" autocomplete="off"></label>
                                        <label class="btn btn-select-color btn-sm bg-secondary"><input type="radio"
                                                name="color" value="secondary" autocomplete="off"></label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
